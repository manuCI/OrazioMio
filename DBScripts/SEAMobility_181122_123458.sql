...
create table `carnet` (
   ...
   `corserimanenti`  integer  not null,
...
-- Notizia Recente [ent9]
create table `notizia_recente` (
   `notizia_oid`  integer  not null,
  primary key (`notizia_oid`)
);
...
-- GEN FK: Notizia Recente --> Notizia
alter table `notizia_recente`   add index fk_notizia_recente_notizia (`notizia_oid`), add constraint fk_notizia_recente_notizia foreign key (`notizia_oid`) references `notizia` (`oid`);
