...
alter table `notizia`   add index fk_notizia_redattore (`redattore_oid_2`), add constraint fk_notizia_redattore foreign key (`redattore_oid_2`) references `redattore` (`user_oid`);
